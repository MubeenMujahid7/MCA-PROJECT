...
while(True):
    ...
    for (x,y,w,h) in right_eye:
        ...
        print("right_eye_pred "+str(right_eye_pred[0][0]))
        if(right_eye_pred[0][0] <= 0.1 ):
            labels = 'Open' 
        if(right_eye_pred[0][0]>= 0.2):
            labels = 'Closed'
        break
    ...
    for (x,y,w,h) in left_eye:
        ...
        print("left_eye_pred "+str(left_eye_pred[0][0]))
        if(left_eye_pred[0][0]<= 0.1 ):
            labels ='Open'   
        if(left_eye_pred[0][0] >= 0.2):
            labels ='Closed'
        break

    if(right_eye_pred[0][0]  >= 0.2 and left_eye_pred[0][0] >= 0.2 ):
        time += 1
